                        ...
                        <h1 className="title" style={{fontSize:"2.5em!important",fontWeight:"400"}}>3 Easy Steps</h1>                 
                            ...
                            {/*img size for mobile!! width: 50px; height: 50px; */}
                                <Col xs={24} sm={24} md={8} lg={8}>
                                    <img src="https://lynagails-caters.s3-ap-southeast-1.amazonaws.com/uploads/Dezynspace/Group+229.png" className="arrow" />
                                    <p>Decide the length of time you need your dedicated designer.</p>
                                </Col>
                                <Col xs={24} sm={24} md={8} lg={8}>
                                    <img src="https://lynagails-caters.s3-ap-southeast-1.amazonaws.com/uploads/Dezynspace/Group+230.png"  className="arrow"/>
                                    <p>Settle the agreed cost online. Hassle-free,secure, and easy!</p>
                                </Col>
                                <Col xs={24} sm={24} md={8} lg={8}>
                                    <img src="https://lynagails-caters.s3-ap-southeast-1.amazonaws.com/uploads/Dezynspace/Group+231.png"  className="arrow" />
                                    <p>In less than 24 hours from confirmed payment,a dedicated graphic designer will contact you to get started.</p>
                                </Col>
                                <Col xs={24} sm={24} md={24} lg={24}>
                                <a  href="" style={{textDecoration:'underline',margin:'25px 5px',color:'#f2273b',position:'relative',top:'70px'}}>See why clients love working with our dedicated designers!</a>
                                </Col>
                            </Row>
                            </div>
