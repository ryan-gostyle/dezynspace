        ...
        return (
            <div className="col-24 section-seven" style={{margin:"0 0 30px 0",overflow:"hidden",}}>
                ...
                <Col xs={24} sm={24} md={7} lg={7} className="pink-gradient" >
                    ...
                    <div class="price-box" style={{height:'auto',minHeight:'145px',width:'300px',background:'#fff',margin:'0 auto',marginTop:'20px',marginBottom:'15px',borderRadius:'2px',padding:'15px 10px'}}>
                        <h2>2 Days</h2>
                ...
                <Col xs={24} sm={24} md={17} lg={17} className="" style={{maxHeight: 1000, display:'inline-block', position:'relative'}}>
                    ...
                    <h2 style={{fontSize:'2.4em',color:'#2b3a67',margin:'15px 10px'}}>Work with your pre-vetted and highly trained professional graphic designer exclusively</h2>
                        <ul>
